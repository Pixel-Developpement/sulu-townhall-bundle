    ...
    public function configureViews(ViewCollection $viewCollection): void
    {
        ...
        if ($this->securityChecker->hasPermission(Report::SECURITY_CONTEXT, PermissionTypes::EDIT)) {
            ...
            if ($this->activityViewBuilderFactory->hasActivityListPermission()) {
                $viewCollection->add(
                    $this->activityViewBuilderFactory->createActivityListViewBuilder(static::EDIT_FORM_VIEW . ".activity", "/activity", Report::RESOURCE_KEY)
                        ->setParent(static::EDIT_FORM_VIEW)
                );
            }
            ...
            if ($this->referenceViewBuilderFactory->hasReferenceListPermission()) {
                $viewCollection->add(
                    $this->referenceViewBuilderFactory->createReferenceListViewBuilder(static::EDIT_FORM_VIEW . ".insights.reference", "/references", Report::RESOURCE_KEY)
                        ->setParent(static::EDIT_FORM_VIEW)
                );
            }
        }
