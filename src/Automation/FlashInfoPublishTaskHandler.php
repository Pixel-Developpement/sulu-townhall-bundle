...
class FlashInfoPublishTaskHandler implements AutomationTaskHandlerInterface
{
    ...
    {
        return TaskHandlerConfiguration::create($this->translator->trans("townhall.flash_info.publish"));
    }
}
