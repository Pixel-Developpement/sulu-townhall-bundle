 ...
 * @ORM\Entity(repositoryClass="Pixel\TownHallBundle\Repository\PublicMarketRepository")
...
class PublicMarket
{
     ...
     * @ORM\OneToMany(targetEntity="Pixel\TownHallBundle\Entity\PublicMarketTranslation", mappedBy="publicMarket", cascade={"ALL"}, indexBy="locale")
     * @Serializer\Exclude()
     */
